...
- We have more then 7000 Symbols in 652x652px extracted from SF Symbols
...
- ### Exemple: ⬇︎ Create Icon with ➤ [internaldrive.png](https://github.com/chris1111/SF-Symbols-Composer-PNG/blob/main/Symbols-PNG/I/internaldrive.png) using [Icon Composer](https://developer.apple.com/icon-composer/), view file ➤ [json](https://github.com/chris1111/SF-Symbols-Composer-PNG/blob/main/Exemple/Drive.icon/icon.json)
